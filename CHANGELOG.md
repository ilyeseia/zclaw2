...
### Changed
- Anthropic requests now mark the system block with `cache_control` so tool definitions and the system prompt can be prompt-cached across tool-call rounds.
